...
from .views import views,CombinedDataView, get_gps_date_data,get_today_gps_date_data, gps_data_date_list,ext_data_date_list, get_utilization_date_hours , get_gps_data
...
urlpatterns = [
    ...
    path('generate-pdf/', CombinedDataView.as_view(), name='generate_pdf'),
    path('generate-csv/', CombinedDataView.as_view(), name='generate_csv'),
